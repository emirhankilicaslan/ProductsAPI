...
namespace ProductsAPI.Models
{
    public class ProductsContext : IdentityDbContext<AppUser, AppRole, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(new Product() {ProductId = 5, ProductName = "iPhone 18", Price = 950000, IsActive = true});
            modelBuilder.Entity<Product>().HasData(new Product() {ProductId = 6, ProductName = "iPhone 19", Price = 110000, IsActive = true});
        }
